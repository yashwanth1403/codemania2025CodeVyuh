...
const projectSuggestions = [
  {
    ...
    description: "Create an AR application that guides new students around campus with interactive elements",
    difficulty: "Medium",
    duration: "72 hours",
  ...
  },
  {
    ...
    description: "Build a dashboard that helps students track and improve their mental and physical wellbeing",
    difficulty: "Easy",
    duration: "48 hours",
  ...
  },
  {
    ...
    description: "Design a system to track and reduce food waste in campus dining halls",
    difficulty: "Hard",
    duration: "96 hours",
      ...
      <main className="container mx-auto px-4 pt-32 pb-20">
        <div className={`transition-all duration-1000 transform ${
          ...
          <p className="text-lg text-gray-300 max-w-2xl mb-8">
            Our neural network analyzes your skills, interests, and availability to find your ideal collaboration partners.
          </p>
          ...
          <div className="flex space-x-2 mb-8 overflow-x-auto pb-2">
            <Button 
              ...
              className={activeSection === 'matches' ? 'bg-cosmic-primary' : 'border-cosmic-light/30 text-cosmic-light'}
            >
            ...
            <Button 
              ...
              className={activeSection === 'skills' ? 'bg-cosmic-primary' : 'border-cosmic-light/30 text-cosmic-light'}
            >
            ...
            <Button 
              ...
              className={activeSection === 'suggestions' ? 'bg-cosmic-primary' : 'border-cosmic-light/30 text-cosmic-light'}
            >
            ...
            <div className="lg:col-span-1">
              <Card className="holographic-card border-0 p-6">
                ...
                <p className="text-sm text-gray-300 mb-6">
                  I'm analyzing your profile to find ideal collaborators. Adjust your preferences for better matches.
                </p>
                
                <h4 className="text-sm font-medium text-cosmic-light mb-3">Matching Preferences</h4>
                ...
                <div className="space-y-4">
                  {Object.entries(matchPreferences).map(([key, value]) => (
                    <div key={key} className="flex items-center justify-between">
                      ...
                      <Switch 
                        checked={value} 
                        onCheckedChange={() => togglePreference(key as keyof typeof matchPreferences)}
