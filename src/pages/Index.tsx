    ...
    <div className="min-h-screen text-white overflow-hidden relative">
      ...
      <main className="container mx-auto px-4 pt-32 pb-20">
        ...
        <div className="flex flex-col items-center text-center mb-16 relative">
          <div className="mb-6">
            <h2
              className={`text-sm uppercase tracking-wider text-cosmic-light mb-3 transition-all duration-1000 transform ${
                isLoaded
            ...
            <h1
              className={`text-4xl md:text-6xl lg:text-7xl font-bold mb-6 transition-all duration-1000 delay-100 transform ${
                isLoaded
                  ? "translate-y-0 opacity-100"
                  : "translate-y-10 opacity-0"
              }`}
            ...
            >
              Join short-term creative challenges with other students across
              disciplines. Find your perfect match for 1-3 day micro-projects
              and build your portfolio while having fun.
            </p>
            <div
            ...
            >
              <Link to="/signup">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-cosmic-secondary to-cosmic-accent hover:from-cosmic-accent hover:to-cosmic-secondary text-lg"
                >
                  Start Collaborating
                </Button>
              </Link>
        ...
        <section
          className={`mb-20 transition-all duration-1000 delay-700 transform ${
            ...
            {[
              {
                ...
                description:
                  "Add your skills, interests, and availability for micro-collaborations",
              },
              {
                number: "02",
                title: "Match & Connect",
                description:
                  "Our AI pairs you with complementary collaborators for short-term projects",
              },
              {
                number: "03",
                title: "Collaborate & Create",
                description:
                  "Work together on bite-sized challenges and build your portfolio",
              },
            ].map((step, index) => (
              <div
                key={index}
        ...
        {/* CTA section */}
        <section
          className={`text-center max-w-4xl mx-auto transition-all duration-1000 delay-800 transform ${
            isLoaded ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
          }`}
        >
          ...
          <p className="text-lg text-gray-300 mb-8">
            Join thousands of students finding their perfect creative match for
            micro-projects that boost skills and portfolios
          </p>
          <Link to="/signup">
            <Button
              size="lg"
